    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 ">
            <div class="text-gray-900 dark:text-gray-100">
                <form method="POST" action="{{ url('/today-foods/update') }} " class="mb-10 space-y-5">
                    @csrf
                    <div>
                        <label for="date"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Date</label>
                        <input class="dark:bg-gray-600 dark:text-slate-100" type="date" id="datepicker" name="date"
                            value="{{ $today_food['date'] }}">
                    </div>
                    <div>
                        <label for="name"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Name</label>
                        <input type="text" id="name" name="name" value="{{ $today_food['name'] }}"
                    ...
                    <div>
                        ...
                        <input type="text" id="calory" name="calory" value="{{ $today_food['calory'] }}"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full md:w-1/2 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
